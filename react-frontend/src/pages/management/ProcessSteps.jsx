...
export default function ProcessSteps() {
    ...
    const fetchData = async (isRefreshing = false) => {
        ...
        try {
            const data = await processStepService.getAll();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (modalMode === 'create') {
                await processStepService.create(formData);
            } else {
                await processStepService.update(selectedStep.id, formData);
            }
    ...
    const openCreateModal = () => {
        if (!canAdd) return;
        setModalMode("create");
        setFormData({ step_name: "", description: "" });
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <div>
                                ...
                                <h2 className={`text-sm font-black uppercase tracking-tight ${textColor}`}>Global Process Steps</h2>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="max-w-[100vw] mx-auto">
                        <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-6">
                            <div className="flex flex-col md:flex-row md:items-center gap-6">
                                <h2 className={`text-3xl font-bold ${textColor}`}>System Process Steps</h2>
                            </div>
                            {canViewToggle && (
