            ...
            {viewMode === 'list' && (
                <div className="flex items-center gap-4">
                    <div className="flex items-center gap-1">
                        <button onClick={(e) => { e.stopPropagation(); openEditModal(item); }} className="p-2 hover:bg-slate-100 dark:hover:bg-white/10 rounded-xl transition-all text-gray-400 hover:text-pink-500"><Edit2 className="w-4 h-4" /></button>
            ...
            <main className="flex-1 flex flex-col h-screen overflow-hidden">
                <header className={`h-16 ${headerBg} border-b px-8 flex items-center justify-between sticky top-0 z-10 shrink-0`}>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button onClick={openCreateModal} className="hidden md:flex items-center gap-2 px-4 py-2 bg-pink-600 hover:bg-pink-700 text-white text-[10px] font-black rounded-xl transition-all shadow-lg shadow-pink-500/20 uppercase tracking-widest"><Plus className="w-3 h-3" /> Add Step</button>
                    </div>
                </header>
                    ...
                    <div className={`${cardBg} w-full max-w-md rounded-[2.5rem] border shadow-2xl relative z-10 animate-in zoom-in-95 duration-200 overflow-hidden`}>
                        <div className="p-8">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <div className="pt-4">
                                    <button disabled={submitting} className="w-full py-4 bg-pink-600 hover:bg-pink-700 text-white font-black uppercase tracking-widest text-xs rounded-2xl flex items-center justify-center gap-2">{submitting ? <Loader2 className="w-4 h-4 animate-spin" /> : "Save Process Step"}</button>
                                </div>
                            </form>
                        </div>
                    </div>
